...
Juzzle() //constructor 
{
   ...
   my_timer=new JLabel("Press any piece to begin"); //New timer label for the timing
...
public void actionPerformed(ActionEvent e)
{
    ...
    int seconds = 120;  // supply timer duration in seconds
   ...
   if(e.getSource()==buttons[j])
   {
       ...
       if(buttons[0].getIcon() == ic2[8] && buttons[1].getIcon() == ic2[7] && buttons[2].getIcon() == ic2[6] && buttons[3].getIcon() == ic2[5] && 
          ...
          buttons[8].getIcon() == ic2[0])
          {
            ...
            int finalScore = (120 / finalCount)*1000;
            scoreArea.setText(String.valueOf(finalScore));
            System.out.println("You won the puzzle");
            timer.stop();
            resetB.doClick();
            JOptionPane.showMessageDialog(null, "Congratulations!", " " + "Juzzle", JOptionPane.INFORMATION_MESSAGE);
          }
